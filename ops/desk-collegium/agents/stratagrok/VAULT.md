# Vault pointer — stratagrok

Specialty: **lead**. Full access (read+write) to vaulted tokens needed for deliverables.
...
## This agent
desk-mail.token / secrets.env (escalate only if missing)
