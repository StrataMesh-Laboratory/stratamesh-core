# Vault pointer — hermes

Specialty: **coord**. Full access (read+write) to vaulted tokens needed for deliverables.
...
## This agent
desk-mail.token + desk sync Bearer; paths in notebook only
