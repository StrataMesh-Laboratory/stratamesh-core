# Vault pointer — openclaw

Specialty: **claw**. Full access (read+write) to vaulted tokens needed for deliverables.
...
## This agent
local claw/probe vault files if present — never feed/chat
