# Vault pointer — fog-assistant

Specialty: **fog**. Full access (read+write) to vaulted tokens needed for deliverables.
...
## This agent
Mac Fog vault for git+live — never echo; Archive Fog role
