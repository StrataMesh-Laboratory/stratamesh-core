...
- LAB only. n=2 P1. M-II HOLD (distinct second host; Oracle optional; oracle_fallback+MDB_active). No workers.dev. No mainnet/aBFT. Discourse announce via browser (no Admin API key on Free plan).
...
- LAB only. n=2 P1. M-II HOLD (distinct second host; Oracle optional; oracle_fallback+MDB_active). No workers.dev. No mainnet/aBFT.
