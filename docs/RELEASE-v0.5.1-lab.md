...
**Current lab cut (2026-09-02).** Adversarial LAB **P1**. Mesh **n=2** (`FOG-NODE-PT-CM-001` + `EDGE-GROK-CMN-001`). Not 0.4.1. Public `/health` n=1 origin=session mac_live=false is a session-origin software flag, not lab n=1.
