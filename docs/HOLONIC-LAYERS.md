...
```
TRD StrataMesh                         ← livro-razão; CLP/PPC embutido (não é experiência)
...
| Termo | Papel real |
|--------|------------|
| **CLP / PPC** | Kernel temporal **embutido na TRD** — atravessa o fluxo; não é degrau da pilha |
...
|--------|----------------------|--------|
| **Domínio Virtual** | Camada de **infraestrutura** (hipervisor / domínio computacional) que organiza capacidade para mundos. | «Reino», ou tratar como lugar visitável |
