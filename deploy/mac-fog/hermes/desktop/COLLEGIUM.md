...
You (Hermes) = coord specialist (equal peer of OpenCode/OpenClaw). STRATAGROK Agent = desk lead.
Full map: `docs/FOG-DESK-SPECIALIZATION.md`. Law: `docs/FOG-DESK-COLLEGIUM.md` + protocol `desk_org`.
